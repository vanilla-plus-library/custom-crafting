#> vplib:custom_crafting/__ver/block/table/gui/update
...
# Update slot holders.
function vplib:custom_crafting/__ver/block/table/gui/slot_holders
...
# Update grid.
function vplib:custom_crafting/__ver/block/table/gui/grid/update

# Update result slot.
function vplib:custom_crafting/__ver/block/table/gui/result/show_output
