#> vplib:custom_crafting/__ver/block/table/gui/result/compare
...
execute if score #result_changed vplib.temp matches 1 run function vplib:custom_crafting/__ver/block/table/gui/result/changed