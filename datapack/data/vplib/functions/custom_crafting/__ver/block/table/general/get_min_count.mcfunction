#> vplib:custom_crafting/__ver/block/table/general/get_min_count
...
execute if data storage vplib:temp array[-1] run function vplib:custom_crafting/__ver/block/table/general/get_min_count