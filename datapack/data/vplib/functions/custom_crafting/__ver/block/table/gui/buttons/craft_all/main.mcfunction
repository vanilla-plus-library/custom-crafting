#> vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/main
...
function vplib:custom_crafting/__ver/block/table/general/get_min_count
...
execute if score #loop vplib.temp matches 1.. run function vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/loop
#tellraw @a ["Items: ",{"nbt":"array","storage": "vplib:temp"}]

# Search players
scoreboard players set #found_player vplib.temp 0
execute if score #output vplib.temp matches 1.. as @a[distance=..12] run function vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/search_player

# Subtract grid if player was found
execute if score #found_player vplib.temp matches 1 run function vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/subtract_grid