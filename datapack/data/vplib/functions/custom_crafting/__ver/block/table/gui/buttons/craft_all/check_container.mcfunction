#> vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/check_container
...
execute if score #grid_changed vplib.temp matches 0 if score #result_changed vplib.temp matches 0 run function vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/main