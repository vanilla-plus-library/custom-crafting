#> vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/give
...
execute positioned ~ ~0.5 ~ as @e[type=minecraft:item,distance=..0.25,nbt={Age:0s}] run function vplib:custom_crafting/__ver/block/table/general/summon_items_2
