...
# Set barrel
setblock ~ ~ ~ minecraft:barrel[facing=up]{CustomName:'[{"translate":"vplib.gui.universal_crafting_table","font":"vplib:custom_crafting/__ver/gui","color":"white","italic":false,"bold":false},{"translate":"vplib.block.universal_crafting_table","font":"minecraft:default","color":"dark_gray"}]'}
