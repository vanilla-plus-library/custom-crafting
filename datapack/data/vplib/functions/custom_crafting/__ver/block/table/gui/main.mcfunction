#> vplib:custom_crafting/__ver/block/table/gui/main
...
execute unless score #slot_holders vplib.temp matches 17 run function vplib:custom_crafting/__ver/block/table/gui/slot_holders

# Get result slot.
function vplib:custom_crafting/__ver/block/table/general/get_result
...
execute if score @s vplib.data matches 1.. unless entity @s[tag=vplib.recipe_changed] if data storage vplib:temp containerResult run function vplib:custom_crafting/__ver/block/table/gui/result/compare
...
execute if score @s vplib.data matches 1.. unless data storage vplib:temp containerResult run function vplib:custom_crafting/__ver/block/table/gui/crafted


# Get grid slots.
function vplib:custom_crafting/__ver/block/table/general/get_grid
...
execute if score #update_grid vplib.temp matches 1 run function vplib:custom_crafting/__ver/block/table/gui/grid/update


# Show result(from recipe output).
execute if score #update_result vplib.temp matches 1 run function vplib:custom_crafting/__ver/block/table/gui/result/show_output

# Check if result slot holder changed.
execute if score #update_result vplib.temp matches 0 unless score @s vplib.data matches 1.. unless data storage vplib:temp containerResult{Count:1b,tag:{vplib:{slot_holder:1b,type:2b}}} run function vplib:custom_crafting/__ver/block/table/gui/result/drop_item
