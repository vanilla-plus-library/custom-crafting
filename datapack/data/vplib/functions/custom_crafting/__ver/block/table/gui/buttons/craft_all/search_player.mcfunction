#> vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/search_player
...
# Proceed if true
execute if score #found_player vplib.temp matches 0 if score #clicked vplib.temp matches 1.. at @s run function vplib:custom_crafting/__ver/block/table/gui/buttons/craft_all/give
