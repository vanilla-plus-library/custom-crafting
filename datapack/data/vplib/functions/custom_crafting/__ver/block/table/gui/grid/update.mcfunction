#> vplib:custom_crafting/__ver/block/table/gui/grid/update
...
execute if data storage vplib:temp containerGrid[0] run function vplib:custom_crafting/__ver/block/table/gui/grid/recipes
