...
# Schedule next tick
execute if score #vplib.load vplib.recipe matches 1.. run schedule function vplib:custom_crafting/__ver/load/recipes 1t replace
...
# Update GUIs
execute if score #vplib.load vplib.recipe matches 11 as @e[type=minecraft:armor_stand,tag=vplib.block.universal_crafting_table] at @s run function vplib:custom_crafting/__ver/block/table/gui/update
